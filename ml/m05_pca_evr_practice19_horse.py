...
n_components = np.array([130, 407, 900])
...
for i in reversed(n_components):
    ...
    model.add(Dense(128, input_shape = (i, ), activation = 'relu', padding = 'same'))
    model.add(Dense(128, activation = 'relu', padding = 'same'))
    model.add(Dropout(0.25))
    model.add(Dense(128, activation = 'relu', padding = 'same'))
    model.add(Dropout(0.25))
    model.add(Dense(64, activation = 'relu', padding = 'same'))
    model.add(Dropout(0.25))
    model.add(Dense(64, activation = 'relu', padding = 'same'))
    model.add(Dropout(0.25))
    model.add(Flatten())
