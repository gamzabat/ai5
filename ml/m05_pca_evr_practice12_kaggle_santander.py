...
n_components = np.array([186, 197, 200])
...
for i in reversed(n_components):
    ...
    PATH = './_save/ml05/12-kaggle-santander/'
...
# n_components = 200
# loss : [0.22898657619953156, 0.9140999913215637]
# acc : 0.9141

# n_components = 186
# loss : [0.23168325424194336, 0.9128999710083008]
# acc : 0.9129

# n_components = 197
# loss : [0.2299909144639969, 0.9136000275611877]
# acc : 0.9136