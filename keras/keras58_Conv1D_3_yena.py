...
from tensorflow.keras.layers import Dense, LSTM, GRU, BatchNormalization, Dropout, Flatten, Conv1D, MaxPooling1D
...
model.add(Conv1D(64, 2, input_shape=(144, 16)))
...
PATH_TO_CSV = "c:/ai5/_save/keras55/"
