...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, BatchNormalization, LSTM
...
model.add(LSTM(units = 64, input_shape = (96, 32), return_sequences = True, activation = 'relu'))
