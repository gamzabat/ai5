...
model.add(Conv1D(filters = 10, kernel_size = 3, input_shape = (8, 8), activation='relu'))
...
# loss : [0.04041828587651253, 0.9916666746139526] - CNN
# acc : 0.9916666666666667
# fit time 11.93 초

# loss : [2.299891948699951, 0.10000000149011612] - LSTM
# acc : 0.1
# fit time 6.77 sec

# loss : [0.15784290432929993, 0.9555555582046509] - Conv1D
