...
model.add(Conv1D(filters = 10, kernel_size = 3, input_shape = (31, 3), activation='relu'))
...
PATH = './_save/keras60/13-kaggle-otto/'
...
# loss : [0.23456338047981262, 0.9103000164031982] - Conv1D
# acc : 0.9103
# fit time 30.85 sec