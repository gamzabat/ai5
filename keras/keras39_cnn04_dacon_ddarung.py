...
x_train = x_train.values.reshape(-1, 2, 2, 2)
x_test = x_test.values.reshape(-1, 2, 2, 2)
...
PATH = './_save/keras39/04-dacon-ddarung/'
...
# loss : [0.17503024637699127, 0.7675675749778748]
