...
model.add(LSTM(units = 128, input_shape = (20, 10), return_sequences = True, activation = 'relu'))
model.add(BatchNormalization())
...
PATH = './_save/keras59/12-kaggle-santander/'
...
# loss : [0.21581239998340607, 0.9204999804496765] - CNN
# acc : 0.9205
# fit time 78.8 sec

# loss : [0.3201279044151306, 0.8995000123977661] - LSTM
# acc : 0.8995
# fit time 312.28 sec