...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPooling2D, Input, LSTM
...
model.add(LSTM(units = 64, input_shape = (28, 28), return_sequences = True, activation = 'relu'))
