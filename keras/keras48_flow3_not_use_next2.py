...
print(type(xy_data)) # .next()가 있으면 tuple 없으면 NumpyArrayIterator

#print(xy_data.shape) # 'NumpyArrayIterator' object has no attribute 'shape'
#print(xy_data[0].shape) # 'tuple' object has no attribute 'shape'
print(xy_data[0][0].shape) # (32, 28, 28, 1)
print(xy_data[3][0].shape) # (4, 28, 28, 1)
#print(xy_data[4][0].shape) # Asked to retrieve element 4, but the Sequence has length 4
