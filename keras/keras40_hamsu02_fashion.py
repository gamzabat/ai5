...
conv2D3 = Conv2D(32, 3, activation = 'relu', padding = 'same')(maxPooling2D1)
conv2D4 = Conv2D(32, 2, activation = 'relu', padding = 'same')(conv2D3)
maxPooling2D2 = MaxPooling2D()(conv2D4)
conv2D4 = Conv2D(32, 2, activation = 'relu', padding = 'same')(maxPooling2D2)
conv2D4 = Conv2D(32, 2, activation = 'relu', padding = 'same')(conv2D4)
maxPooling2D3 = MaxPooling2D()(conv2D4)
flatten1 = Flatten()(maxPooling2D3)
