...
xy_train_woman = x_train[np.where(y_train > 0.0)]

augment_size = 7000

print(x_train.shape[0])

randidx = np.random.randint(xy_train_woman.shape[0], size = augment_size)

print(np.min(randidx), np.max(randidx))
print(x_train[0].shape) # (100, 100)

x_augmented = xy_train_woman[randidx].copy()
y_augmented = np.full((augment_size,), 1.0)
...
# loss : [0.15333998203277588, 0.9464482665061951]
# acc : 0.9464482885535517
# fit time 249.09 sec