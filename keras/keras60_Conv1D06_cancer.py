...
# model.add(LSTM(units = 64, input_shape = (15, 2), return_sequences = True, activation = 'relu'))
# model.add(LSTM(units = 64, return_sequences = True, activation = 'relu'))
# model.add(LSTM(units = 64, activation = 'relu'))

model.add(Conv1D(filters = 10, kernel_size = 3, input_shape = (15, 2), activation='relu'))
...
# loss : [0.151704341173172, 0.9385964870452881] - CNN
# acc : 0.9385964912280702
# fit time 8.35 sec

# loss : [0.3377392292022705, 0.859649121761322] - LSTM
# acc : 0.8596491228070176
# fit time 5.96 sec

# loss : [0.11875271052122116, 0.9561403393745422] - Conv1D
