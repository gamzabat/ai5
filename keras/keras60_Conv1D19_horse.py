...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPooling2D, Input, BatchNormalization, LSTM, Conv1D
...
model.add(Conv1D(filters = 32, kernel_size = 3, input_shape = (300, 100), activation='relu'))
model.add(Flatten()) 
...
PATH = './_save/keras60/imageDataGenerator4/'
...
# loss : [0.011994075961411, 0.9950000047683716] - CNN
# acc : 0.995
# fit time 64.14 초

# loss : [0.3683546781539917, 0.8500000238418579] - LSTM
# acc : 0.85
# fit time 44.0 초

# loss : [0.16211269795894623, 0.9449999928474426] - Conv1D
# acc : 0.945
# fit time 6.83 초