...
model.add(Conv1D(filters = 10, kernel_size = 3, input_shape = (5, 2), activation='relu'))
...
PATH = './_save/keras60/08-kaggle-bank/'
...
# loss : [0.3217844069004059, 0.8654831051826477] - CNN
# acc : 0.8654830793468052
# fit time 63.98 sec

# loss : [0.32487356662750244, 0.8637561798095703] - LSTM
# acc : 0.8637561729330142
# fit time 224.72 sec

# loss : [0.3270815312862396, 0.863453209400177] - Conv1D
# acc : 0.863453206895507
# fit time 28.41 sec